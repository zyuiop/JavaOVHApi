...
public interface Cloud { 
	...
	*/
	 ...
	 * @param pcsServiceName The internal name of your PCS offer
	*/
	net.zyuiop.ovhapi.api.objects.complextype.UnitAndValue getServiceNamePcsPcsServiceNameGlobalUsage(java.lang.String serviceName, java.lang.String pcsServiceName) throws java.io.IOException;
	...
	*/
	 ...
	 * Facultative parameters ? false
	 * @param to Get usage to
	 * @param from Get usage from
	 * @param serviceName The project id
	*/
	net.zyuiop.ovhapi.api.objects.cloud.project.ProjectUsage getProjectServiceNameConsumption(java.util.Date to, java.util.Date from, java.lang.String serviceName) throws java.io.IOException;
