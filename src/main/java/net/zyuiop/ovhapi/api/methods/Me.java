...
public interface Me { 
	...
	*/
	 ...
	 * @param orderId null
	*/
	net.zyuiop.ovhapi.api.objects.billing.order.PaymentMeans getOrderOrderIdPaymentMeans(long orderId) throws java.io.IOException;
	...
	*/
	void putInstallationTemplateTemplateNamePartitionSchemeSchemeName(net.zyuiop.ovhapi.api.objects.dedicated.installationtemplate.TemplatePartitioningSchemes param0, java.lang.String templateName, java.lang.String schemeName) throws java.io.IOException;
	...
	*/
	 ...
	 * @param id null
	*/
	net.zyuiop.ovhapi.api.objects.nichandle.emailchange.Task getTaskEmailChangeId(long id) throws java.io.IOException;
	...
	*/
	void putInstallationTemplateTemplateNamePartitionSchemeSchemeNameHardwareRaidName(net.zyuiop.ovhapi.api.objects.dedicated.installationtemplate.HardwareRaid param0, java.lang.String templateName, java.lang.String schemeName, java.lang.String name) throws java.io.IOException;
	...
	*/
	 ...
	 * @param mountpoint partition mount point
	*/
	void putInstallationTemplateTemplateNamePartitionSchemeSchemeNamePartitionMountpoint(net.zyuiop.ovhapi.api.objects.dedicated.installationtemplate.TemplatePartitions param0, java.lang.String templateName, java.lang.String schemeName, java.lang.String mountpoint) throws java.io.IOException;
	...
	*/
	 ...
	 * Facultative parameters ? false
	 * @param phone Cell phone number to register
	*/
	net.zyuiop.ovhapi.api.objects.nichandle.accessrestriction.SmsSecret postAccessRestrictionSms(java.lang.String phone) throws java.io.IOException;
	...
	*/
	 ...
	 * @param code OTP code given by the application
	*/
	net.zyuiop.ovhapi.api.objects.nichandle.accessrestriction.SOTPValidate postAccessRestrictionBackupCodeValidate(java.lang.String code) throws java.io.IOException;
	...
	*/
	net.zyuiop.ovhapi.api.objects.nichandle.document.Document getDocumentId(java.lang.String id) throws java.io.IOException;
	...
	*/
	 ...
	 * @param id Document id
	*/
	void putDocumentId(net.zyuiop.ovhapi.api.objects.nichandle.document.Document param0, java.lang.String id) throws java.io.IOException;
	...
	*/
	 ...
	 * @param templateName This template name
	*/
	net.zyuiop.ovhapi.api.objects.dedicated.installationtemplate.Templates getInstallationTemplateTemplateName(java.lang.String templateName) throws java.io.IOException;

	/**
	 * Add a SOTP access restriction
	 * Facultative parameters ? false
	*/
	net.zyuiop.ovhapi.api.objects.nichandle.accessrestriction.SOTPSecret postAccessRestrictionBackupCode() throws java.io.IOException;
	...
	*/
	 ...
	 * @param mountpoint partition mount point
	*/
	net.zyuiop.ovhapi.api.objects.dedicated.installationtemplate.TemplatePartitions getInstallationTemplateTemplateNamePartitionSchemeSchemeNamePartitionMountpoint(java.lang.String templateName, java.lang.String schemeName, java.lang.String mountpoint) throws java.io.IOException;
	...
	*/
	 ...
	 * @param id The Id of the restriction
	*/
	net.zyuiop.ovhapi.api.objects.nichandle.accessrestriction.TOTPAccount getAccessRestrictionTotpId(long id) throws java.io.IOException;
	...
	*/
	 ...
	 * @param id The Id of the restriction
	*/
	net.zyuiop.ovhapi.api.objects.nichandle.accessrestriction.SmsCode postAccessRestrictionSmsIdSendCode(long id) throws java.io.IOException;
	...
	*/
	 ...
	 * Facultative parameters ? false
	*/
	net.zyuiop.ovhapi.api.objects.nichandle.accessrestriction.SOTPAccount getAccessRestrictionBackupCode() throws java.io.IOException;
	...
	*/
	 ...
	 * @param name Hardware RAID name
	*/
	net.zyuiop.ovhapi.api.objects.dedicated.installationtemplate.HardwareRaid getInstallationTemplateTemplateNamePartitionSchemeSchemeNameHardwareRaidName(java.lang.String templateName, java.lang.String schemeName, java.lang.String name) throws java.io.IOException;
	...
	*/
	 ...
	 * Facultative parameters ? false
	*/
	net.zyuiop.ovhapi.api.objects.nichandle.accessrestriction.TOTPSecret postAccessRestrictionTotp() throws java.io.IOException;
	...
	*/
	 ...
	 * @param templateName This template name
	*/
	void putInstallationTemplateTemplateName(net.zyuiop.ovhapi.api.objects.dedicated.installationtemplate.Templates param0, java.lang.String templateName) throws java.io.IOException;
	...
	*/
	 ...
	 * @param id null
	*/
	net.zyuiop.ovhapi.api.objects.nichandle.contactchange.Task getTaskContactChangeId(long id) throws java.io.IOException;
	...
	*/
	 ...
	 * Facultative parameters ? false
	 * @param newEmail New email to associate to your account
	*/
	net.zyuiop.ovhapi.api.objects.nichandle.emailchange.Task postChangeEmail(java.lang.String newEmail) throws java.io.IOException;
	...
	*/
	 ...
	 * @param schemeName name of this partitioning scheme
	*/
	net.zyuiop.ovhapi.api.objects.dedicated.installationtemplate.TemplatePartitioningSchemes getInstallationTemplateTemplateNamePartitionSchemeSchemeName(java.lang.String templateName, java.lang.String schemeName) throws java.io.IOException;
	...
	*/
	net.zyuiop.ovhapi.api.objects.nichandle.document.Document postDocument(java.lang.String name, net.zyuiop.ovhapi.api.objects.complextype.SafeKeyValue tags) throws java.io.IOException;
	 ...
	 * @param name File name
	*/
	net.zyuiop.ovhapi.api.objects.nichandle.document.Document postDocument(java.lang.String name) throws java.io.IOException;
	...
	*/
	 ...
	 * @param id The Id of the restriction
	*/
	net.zyuiop.ovhapi.api.objects.nichandle.accessrestriction.SmsAccount getAccessRestrictionSmsId(long id) throws java.io.IOException;
