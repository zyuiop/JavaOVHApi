...
public interface Ip { 
	...
	*/
	net.zyuiop.ovhapi.api.objects.ip.GameMitigationRule deleteIpGameIpOnGameRuleId(java.lang.String ip, java.lang.String ipOnGame, long id) throws java.io.IOException;
	...
	*/
	 ...
	 * @param id ID of the rule
	*/
	net.zyuiop.ovhapi.api.objects.ip.GameMitigationRule getIpGameIpOnGameRuleId(java.lang.String ip, java.lang.String ipOnGame, long id) throws java.io.IOException;
	...
	*/
	 ...
	 * @param ip null
	 * @param ipOnFirewall null
	 * @param tcpOption Option on your rule. Can only be used with TCP protocol
	 * @param source Source ip for your rule. Any if not set
	...
	*/
	 ...
	 * Facultative parameters ? false
	 * @param protocol The protocol running behind the given port
	 * @param ports The UDP port range to apply the rule on
	 * @param ip null
	 * @param ipOnGame null
	*/
	net.zyuiop.ovhapi.api.objects.ip.GameMitigationRule postIpGameIpOnGameRule(java.lang.String protocol, net.zyuiop.ovhapi.api.objects.complextype.Range ports, java.lang.String ip, java.lang.String ipOnGame) throws java.io.IOException;
	...
	*/
	 ...
	 * Facultative parameters ? false
	 * @param null The port you want to redirect to
	 * @param serviceName The internal name of your IP load balancing
	*/
	net.zyuiop.ovhapi.api.objects.ip.LoadBalancingTask postLoadBalancingServiceNamePortsRedirection(net.zyuiop.ovhapi.api.objects.ip.loadbalancingip.LoadBalancingPort param0, java.lang.String serviceName) throws java.io.IOException;
	...
	*/
	 ...
	 * @param srcPort The port you want to redirect from
	*/
	net.zyuiop.ovhapi.api.objects.ip.loadbalancingip.LoadBalancingPort getLoadBalancingServiceNamePortsRedirectionSrcPort(java.lang.String serviceName, long srcPort) throws java.io.IOException;
