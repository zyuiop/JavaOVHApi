...
public class CreationRules { 
	...
	public CreationRules firstname(net.zyuiop.ovhapi.api.objects.nichandle.CreationRule firstname) { 
		this.firstname = firstname;
		return this;
	} 
	...
	public CreationRules vat(net.zyuiop.ovhapi.api.objects.nichandle.CreationRule vat) { 
		this.vat = vat;
		return this;
	} 
	...
	public CreationRules area(net.zyuiop.ovhapi.api.objects.nichandle.CreationRule area) { 
		this.area = area;
		return this;
	} 
	...
	public CreationRules birthDay(net.zyuiop.ovhapi.api.objects.nichandle.CreationRule birthDay) { 
		this.birthDay = birthDay;
		return this;
	} 
	...
	public CreationRules nationalIdentificationNumber(net.zyuiop.ovhapi.api.objects.nichandle.CreationRule nationalIdentificationNumber) { 
		this.nationalIdentificationNumber = nationalIdentificationNumber;
		return this;
	} 
	...
	public CreationRules ovhSubsidiary(net.zyuiop.ovhapi.api.objects.nichandle.CreationRule ovhSubsidiary) { 
		this.ovhSubsidiary = ovhSubsidiary;
		return this;
	} 
	...
	public CreationRules spareEmail(net.zyuiop.ovhapi.api.objects.nichandle.CreationRule spareEmail) { 
		this.spareEmail = spareEmail;
		return this;
	} 
	...
	public CreationRules ovhCompany(net.zyuiop.ovhapi.api.objects.nichandle.CreationRule ovhCompany) { 
		this.ovhCompany = ovhCompany;
		return this;
	} 
	...
	public CreationRules email(net.zyuiop.ovhapi.api.objects.nichandle.CreationRule email) { 
		this.email = email;
		return this;
	} 
	...
	public CreationRules city(net.zyuiop.ovhapi.api.objects.nichandle.CreationRule city) { 
		this.city = city;
		return this;
	} 
	...
	public CreationRules fax(net.zyuiop.ovhapi.api.objects.nichandle.CreationRule fax) { 
		this.fax = fax;
		return this;
	} 
	...
	public CreationRules address(net.zyuiop.ovhapi.api.objects.nichandle.CreationRule address) { 
		this.address = address;
		return this;
	} 
	...
	public CreationRules companyNationalIdentificationNumber(net.zyuiop.ovhapi.api.objects.nichandle.CreationRule companyNationalIdentificationNumber) { 
		this.companyNationalIdentificationNumber = companyNationalIdentificationNumber;
		return this;
	} 
	...
	public CreationRules birthCity(net.zyuiop.ovhapi.api.objects.nichandle.CreationRule birthCity) { 
		this.birthCity = birthCity;
		return this;
	} 
	...
	public CreationRules country(net.zyuiop.ovhapi.api.objects.nichandle.CreationRule country) { 
		this.country = country;
		return this;
	} 
	...
	public CreationRules organisation(net.zyuiop.ovhapi.api.objects.nichandle.CreationRule organisation) { 
		this.organisation = organisation;
		return this;
	} 
	...
	public CreationRules language(net.zyuiop.ovhapi.api.objects.nichandle.CreationRule language) { 
		this.language = language;
		return this;
	} 
	...
	public CreationRules name(net.zyuiop.ovhapi.api.objects.nichandle.CreationRule name) { 
		this.name = name;
		return this;
	} 
	...
	public CreationRules phone(net.zyuiop.ovhapi.api.objects.nichandle.CreationRule phone) { 
		this.phone = phone;
		return this;
	} 
	...
	public CreationRules sex(net.zyuiop.ovhapi.api.objects.nichandle.CreationRule sex) { 
		this.sex = sex;
		return this;
	} 
	...
	public CreationRules zip(net.zyuiop.ovhapi.api.objects.nichandle.CreationRule zip) { 
		this.zip = zip;
		return this;
	} 
	...
	public CreationRules corporationType(net.zyuiop.ovhapi.api.objects.nichandle.CreationRule corporationType) { 
		this.corporationType = corporationType;
		return this;
	} 
	...
	public CreationRules legalform(net.zyuiop.ovhapi.api.objects.nichandle.CreationRule legalform) { 
		this.legalform = legalform;
		return this;
	} 
