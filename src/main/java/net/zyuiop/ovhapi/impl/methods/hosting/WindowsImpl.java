...
public class WindowsImpl implements Windows { 
	...
	public java.lang.String getHostingWindows() throws java.io.IOException {
		String callUrl = "https://api.ovh.com/1.0//hosting/windows";
		String data = "?";
	...
	public net.zyuiop.ovhapi.api.objects.hosting.windows.Service getServiceName(java.lang.String serviceName) throws java.io.IOException {
		...
		OVHApiMethod method = OVHApiMethod.GET;
		URL url = new URL(callUrl);
		return new Gson().fromJson(this.client.callRaw(url, method, data, true), net.zyuiop.ovhapi.api.objects.hosting.windows.Service.class);
	}
