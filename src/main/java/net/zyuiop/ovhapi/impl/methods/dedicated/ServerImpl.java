...
public class ServerImpl implements Server { 
	...
	public net.zyuiop.ovhapi.api.objects.dedicated.server.RtmRaidVolume getServiceNameStatisticsRaidUnitVolumeVolume(java.lang.String serviceName, java.lang.String unit, java.lang.String volume) throws java.io.IOException {
		String __callUrl = "https://api.ovh.com/1.0/dedicated/server/" + serviceName + "/statistics/raid/" + unit + "/volume/" + volume + "";
		String __data = "?";
		__data += "serviceName=" + serviceName;
		__data += "unit=" + unit;
		...
		OVHApiMethod __method = OVHApiMethod.GET;
		URL __url = new URL(__callUrl);
		return new Gson().fromJson(this.client.callRaw(__url, __method, __data, true), net.zyuiop.ovhapi.api.objects.dedicated.server.RtmRaidVolume.class);
	}
	...
	public net.zyuiop.ovhapi.api.objects.secondarydns.SecondaryDNSNameServer getServiceNameSecondaryDnsNameServerAvailable(java.lang.String serviceName) throws java.io.IOException {
		String __callUrl = "https://api.ovh.com/1.0/dedicated/server/" + serviceName + "/secondaryDnsNameServerAvailable";
		String __data = "?";
		__data += "serviceName=" + serviceName;
		OVHApiMethod __method = OVHApiMethod.GET;
		URL __url = new URL(__callUrl);
	...
	public net.zyuiop.ovhapi.api.objects.complextype.ChartReturn getServiceNameStatisticsChart(java.lang.String period, java.lang.String type, java.lang.String serviceName) throws java.io.IOException {
		String __callUrl = "https://api.ovh.com/1.0/dedicated/server/" + serviceName + "/statistics/chart";
		String __data = "?";
		...
		OVHApiMethod __method = OVHApiMethod.GET;
		URL __url = new URL(__callUrl);
		return new Gson().fromJson(this.client.callRaw(__url, __method, __data, true), net.zyuiop.ovhapi.api.objects.complextype.ChartReturn.class);
	}
	...
	public net.zyuiop.ovhapi.api.objects.dedicated.server.MrtgTimestampValue[] getServiceNameVrackVrackMrtg(java.lang.String period, java.lang.String type, java.lang.String serviceName, java.lang.String vrack) throws java.io.IOException {
		String __callUrl = "https://api.ovh.com/1.0/dedicated/server/" + serviceName + "/vrack/" + vrack + "/mrtg";
		String __data = "?";
		__data += "period=" + period;
		__data += "type=" + type;
		__data += "serviceName=" + serviceName;
	...
	public net.zyuiop.ovhapi.api.objects.dedicated.server.RtmPartition getServiceNameStatisticsPartitionPartition(java.lang.String serviceName, java.lang.String partition) throws java.io.IOException {
		String __callUrl = "https://api.ovh.com/1.0/dedicated/server/" + serviceName + "/statistics/partition/" + partition + "";
		String __data = "?";
		__data += "serviceName=" + serviceName;
		__data += "partition=" + partition;
		OVHApiMethod __method = OVHApiMethod.GET;
		URL __url = new URL(__callUrl);
		return new Gson().fromJson(this.client.callRaw(__url, __method, __data, true), net.zyuiop.ovhapi.api.objects.dedicated.server.RtmPartition.class);
	}
	...
	public void putServiceNameBurst(net.zyuiop.ovhapi.api.objects.dedicated.server.ServerBurst param0, java.lang.String serviceName) throws java.io.IOException {
		String __callUrl = "https://api.ovh.com/1.0/dedicated/server/" + serviceName + "/burst";
		String __data = new Gson().toJson(param0);
		OVHApiMethod __method = OVHApiMethod.PUT;
		URL __url = new URL(__callUrl);
		this.client.callRaw(__url, __method, __data, true);
	...
	public net.zyuiop.ovhapi.api.objects.dedicated.server.RtmMemory[] getServiceNameStatisticsMemory(java.lang.String serviceName) throws java.io.IOException {
		String __callUrl = "https://api.ovh.com/1.0/dedicated/server/" + serviceName + "/statistics/memory";
		String __data = "?";
		__data += "serviceName=" + serviceName;
		OVHApiMethod __method = OVHApiMethod.GET;
		URL __url = new URL(__callUrl);
		return new Gson().fromJson(this.client.callRaw(__url, __method, __data, true), net.zyuiop.ovhapi.api.objects.dedicated.server.RtmMemory[].class);
	}

	public net.zyuiop.ovhapi.api.objects.dedicated.server.RtmDisk getServiceNameStatisticsDiskDisk(java.lang.String serviceName, java.lang.String disk) throws java.io.IOException {
		String __callUrl = "https://api.ovh.com/1.0/dedicated/server/" + serviceName + "/statistics/disk/" + disk + "";
		String __data = "?";
		__data += "serviceName=" + serviceName;
		__data += "disk=" + disk;
		OVHApiMethod __method = OVHApiMethod.GET;
		URL __url = new URL(__callUrl);
		return new Gson().fromJson(this.client.callRaw(__url, __method, __data, true), net.zyuiop.ovhapi.api.objects.dedicated.server.RtmDisk.class);
	}

	public net.zyuiop.ovhapi.api.objects.dedicated.server.RtmCpu getServiceNameStatisticsCpu(java.lang.String serviceName) throws java.io.IOException {
		String __callUrl = "https://api.ovh.com/1.0/dedicated/server/" + serviceName + "/statistics/cpu";
		String __data = "?";
		__data += "serviceName=" + serviceName;
		OVHApiMethod __method = OVHApiMethod.GET;
		URL __url = new URL(__callUrl);
		return new Gson().fromJson(this.client.callRaw(__url, __method, __data, true), net.zyuiop.ovhapi.api.objects.dedicated.server.RtmCpu.class);
	}

	public net.zyuiop.ovhapi.api.objects.dedicated.server.HardwareRaidSize getServiceNameInstallHardwareRaidSize(java.lang.String templateName, java.lang.String partitionSchemeName, java.lang.String serviceName) throws java.io.IOException {
		String __callUrl = "https://api.ovh.com/1.0/dedicated/server/" + serviceName + "/install/hardwareRaidSize";
		String __data = "?";
		__data += "templateName=" + templateName;
		__data += "partitionSchemeName=" + partitionSchemeName;
		__data += "serviceName=" + serviceName;
		OVHApiMethod __method = OVHApiMethod.GET;
		URL __url = new URL(__callUrl);
		return new Gson().fromJson(this.client.callRaw(__url, __method, __data, true), net.zyuiop.ovhapi.api.objects.dedicated.server.HardwareRaidSize.class);
	}
	...
	public net.zyuiop.ovhapi.api.objects.dedicated.server.MrtgTimestampValue[] getServiceNameMrtg(java.lang.String period, java.lang.String type, java.lang.String serviceName) throws java.io.IOException {
		String __callUrl = "https://api.ovh.com/1.0/dedicated/server/" + serviceName + "/mrtg";
		String __data = "?";
		__data += "period=" + period;
		__data += "type=" + type;
		__data += "serviceName=" + serviceName;
	...
	public net.zyuiop.ovhapi.api.objects.dedicated.server.NetworkSpecifications getServiceNameSpecificationsNetwork(java.lang.String serviceName) throws java.io.IOException {
		String __callUrl = "https://api.ovh.com/1.0/dedicated/server/" + serviceName + "/specifications/network";
		String __data = "?";
		__data += "serviceName=" + serviceName;
		OVHApiMethod __method = OVHApiMethod.GET;
		URL __url = new URL(__callUrl);
		return new Gson().fromJson(this.client.callRaw(__url, __method, __data, true), net.zyuiop.ovhapi.api.objects.dedicated.server.NetworkSpecifications.class);
	}
	...
	public net.zyuiop.ovhapi.api.objects.dedicated.server.RtmCommandSize[] getServiceNameStatisticsProcess(java.lang.String serviceName) throws java.io.IOException {
		String __callUrl = "https://api.ovh.com/1.0/dedicated/server/" + serviceName + "/statistics/process";
		String __data = "?";
		__data += "serviceName=" + serviceName;
		OVHApiMethod __method = OVHApiMethod.GET;
		URL __url = new URL(__callUrl);
		return new Gson().fromJson(this.client.callRaw(__url, __method, __data, true), net.zyuiop.ovhapi.api.objects.dedicated.server.RtmCommandSize[].class);
	}
	...
	public net.zyuiop.ovhapi.api.objects.dedicated.server.RtmRaidVolumePort getServiceNameStatisticsRaidUnitVolumeVolumePortPort(java.lang.String serviceName, java.lang.String unit, java.lang.String volume, java.lang.String port) throws java.io.IOException {
		String __callUrl = "https://api.ovh.com/1.0/dedicated/server/" + serviceName + "/statistics/raid/" + unit + "/volume/" + volume + "/port/" + port + "";
		String __data = "?";
		__data += "serviceName=" + serviceName;
		__data += "unit=" + unit;
		__data += "volume=" + volume;
		...
		OVHApiMethod __method = OVHApiMethod.GET;
		URL __url = new URL(__callUrl);
		return new Gson().fromJson(this.client.callRaw(__url, __method, __data, true), net.zyuiop.ovhapi.api.objects.dedicated.server.RtmRaidVolumePort.class);
	}
	...
	public net.zyuiop.ovhapi.api.objects.dedicated.server.HardwareSpecifications getServiceNameSpecificationsHardware(java.lang.String serviceName) throws java.io.IOException {
		String __callUrl = "https://api.ovh.com/1.0/dedicated/server/" + serviceName + "/specifications/hardware";
		String __data = "?";
		__data += "serviceName=" + serviceName;
		OVHApiMethod __method = OVHApiMethod.GET;
		URL __url = new URL(__callUrl);
		return new Gson().fromJson(this.client.callRaw(__url, __method, __data, true), net.zyuiop.ovhapi.api.objects.dedicated.server.HardwareSpecifications.class);
	}
	...
	public net.zyuiop.ovhapi.api.objects.dedicated.server.ServerBurst getServiceNameBurst(java.lang.String serviceName) throws java.io.IOException {
		String __callUrl = "https://api.ovh.com/1.0/dedicated/server/" + serviceName + "/burst";
		String __data = "?";
		__data += "serviceName=" + serviceName;
		OVHApiMethod __method = OVHApiMethod.GET;
		URL __url = new URL(__callUrl);
		return new Gson().fromJson(this.client.callRaw(__url, __method, __data, true), net.zyuiop.ovhapi.api.objects.dedicated.server.ServerBurst.class);
	}
	...
	public net.zyuiop.ovhapi.api.objects.complextype.ChartReturn getServiceNameStatisticsPartitionPartitionChart(java.lang.String period, java.lang.String serviceName, java.lang.String partition) throws java.io.IOException {
		String __callUrl = "https://api.ovh.com/1.0/dedicated/server/" + serviceName + "/statistics/partition/" + partition + "/chart";
		String __data = "?";
		__data += "period=" + period;
		__data += "serviceName=" + serviceName;
		__data += "partition=" + partition;
	...
	public net.zyuiop.ovhapi.api.objects.secondarydns.SecondaryDNSCheckField getServiceNameSecondaryDnsNameDomainToken(java.lang.String domain, java.lang.String serviceName) throws java.io.IOException {
		String __callUrl = "https://api.ovh.com/1.0/dedicated/server/" + serviceName + "/secondaryDnsNameDomainToken";
		String __data = "?";
		__data += "domain=" + domain;
		__data += "serviceName=" + serviceName;
		OVHApiMethod __method = OVHApiMethod.GET;
		URL __url = new URL(__callUrl);
		return new Gson().fromJson(this.client.callRaw(__url, __method, __data, true), net.zyuiop.ovhapi.api.objects.secondarydns.SecondaryDNSCheckField.class);
	}
	...
	public net.zyuiop.ovhapi.api.objects.dedicated.server.HardwareRaidProfile getServiceNameInstallHardwareRaidProfile(java.lang.String serviceName) throws java.io.IOException {
		String __callUrl = "https://api.ovh.com/1.0/dedicated/server/" + serviceName + "/install/hardwareRaidProfile";
		String __data = "?";
		__data += "serviceName=" + serviceName;
		OVHApiMethod __method = OVHApiMethod.GET;
		URL __url = new URL(__callUrl);
		return new Gson().fromJson(this.client.callRaw(__url, __method, __data, true), net.zyuiop.ovhapi.api.objects.dedicated.server.HardwareRaidProfile.class);
	}
	...
	public net.zyuiop.ovhapi.api.objects.dedicated.server.RtmLoad getServiceNameStatisticsLoad(java.lang.String serviceName) throws java.io.IOException {
		String __callUrl = "https://api.ovh.com/1.0/dedicated/server/" + serviceName + "/statistics/load";
		String __data = "?";
		__data += "serviceName=" + serviceName;
		OVHApiMethod __method = OVHApiMethod.GET;
		URL __url = new URL(__callUrl);
		return new Gson().fromJson(this.client.callRaw(__url, __method, __data, true), net.zyuiop.ovhapi.api.objects.dedicated.server.RtmLoad.class);
	}
	...
	public net.zyuiop.ovhapi.api.objects.secondarydns.SecondaryDNSNameServer getServiceNameSecondaryDnsDomainsDomainDnsServer(java.lang.String serviceName, java.lang.String domain) throws java.io.IOException {
		String __callUrl = "https://api.ovh.com/1.0/dedicated/server/" + serviceName + "/secondaryDnsDomains/" + domain + "/dnsServer";
		String __data = "?";
		__data += "serviceName=" + serviceName;
		__data += "domain=" + domain;
		OVHApiMethod __method = OVHApiMethod.GET;
