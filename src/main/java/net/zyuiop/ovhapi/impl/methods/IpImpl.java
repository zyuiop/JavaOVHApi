...
public class IpImpl implements Ip { 
	...
	public net.zyuiop.ovhapi.api.objects.ip.GameMitigationRule deleteIpGameIpOnGameRuleId(java.lang.String ip, java.lang.String ipOnGame, long id) throws java.io.IOException {
		String __callUrl = "https://api.ovh.com/1.0/ip/" + ip + "/game/" + ipOnGame + "/rule/" + id + "";
		Map<Object, Object> __dataMap = new HashMap<>();
		String __data = new Gson().toJson(__dataMap);
		OVHApiMethod __method = OVHApiMethod.DELETE;
		URL __url = new URL(__callUrl);
		return new Gson().fromJson(this.client.callRaw(__url, __method, __data, true), net.zyuiop.ovhapi.api.objects.ip.GameMitigationRule.class);
	}
	...
	public net.zyuiop.ovhapi.api.objects.ip.GameMitigationRule getIpGameIpOnGameRuleId(java.lang.String ip, java.lang.String ipOnGame, long id) throws java.io.IOException {
		String __callUrl = "https://api.ovh.com/1.0/ip/" + ip + "/game/" + ipOnGame + "/rule/" + id + "";
		String __data = "?";
		__data += "ip=" + ip;
		__data += "ipOnGame=" + ipOnGame;
	...
	public net.zyuiop.ovhapi.api.objects.ip.FirewallNetworkRule postIpFirewallIpOnFirewallRule(java.lang.String protocol, long sequence, java.lang.String action, java.lang.String ip, java.lang.String ipOnFirewall, net.zyuiop.ovhapi.api.objects.ip.FirewallOptionTCP tcpOption, java.lang.String source, long destinationPort, long sourcePort) throws java.io.IOException {
		...
		__dataMap.put("tcpOption", tcpOption);
		__dataMap.put("source", source);
		__dataMap.put("destinationPort", destinationPort);
		__dataMap.put("sourcePort", sourcePort);
		String __data = new Gson().toJson(__dataMap);
		OVHApiMethod __method = OVHApiMethod.POST;
		URL __url = new URL(__callUrl);
		return new Gson().fromJson(this.client.callRaw(__url, __method, __data, true), net.zyuiop.ovhapi.api.objects.ip.FirewallNetworkRule.class);
	...
	public net.zyuiop.ovhapi.api.objects.ip.GameMitigationRule postIpGameIpOnGameRule(java.lang.String protocol, net.zyuiop.ovhapi.api.objects.complextype.Range ports, java.lang.String ip, java.lang.String ipOnGame) throws java.io.IOException {
		String __callUrl = "https://api.ovh.com/1.0/ip/" + ip + "/game/" + ipOnGame + "/rule";
		Map<Object, Object> __dataMap = new HashMap<>();
		__dataMap.put("protocol", protocol);
		__dataMap.put("ports", ports);
		String __data = new Gson().toJson(__dataMap);
		OVHApiMethod __method = OVHApiMethod.POST;
		URL __url = new URL(__callUrl);
		return new Gson().fromJson(this.client.callRaw(__url, __method, __data, true), net.zyuiop.ovhapi.api.objects.ip.GameMitigationRule.class);
	...
	public net.zyuiop.ovhapi.api.objects.ip.LoadBalancingTask postLoadBalancingServiceNamePortsRedirection(net.zyuiop.ovhapi.api.objects.ip.loadbalancingip.LoadBalancingPort param0, java.lang.String serviceName) throws java.io.IOException {
		String __callUrl = "https://api.ovh.com/1.0/ip/loadBalancing/" + serviceName + "/portsRedirection";
		String __data = new Gson().toJson(param0);
		OVHApiMethod __method = OVHApiMethod.POST;
		URL __url = new URL(__callUrl);
	...
	public net.zyuiop.ovhapi.api.objects.ip.loadbalancingip.LoadBalancingPort getLoadBalancingServiceNamePortsRedirectionSrcPort(java.lang.String serviceName, long srcPort) throws java.io.IOException {
		String __callUrl = "https://api.ovh.com/1.0/ip/loadBalancing/" + serviceName + "/portsRedirection/" + srcPort + "";
		String __data = "?";
		__data += "serviceName=" + serviceName;
		__data += "srcPort=" + srcPort;
		OVHApiMethod __method = OVHApiMethod.GET;
		URL __url = new URL(__callUrl);
		return new Gson().fromJson(this.client.callRaw(__url, __method, __data, true), net.zyuiop.ovhapi.api.objects.ip.loadbalancingip.LoadBalancingPort.class);
	}
