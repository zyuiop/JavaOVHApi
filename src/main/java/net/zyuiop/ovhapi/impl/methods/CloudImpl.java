...
public class CloudImpl implements Cloud { 
	...
	public net.zyuiop.ovhapi.api.objects.complextype.UnitAndValue getServiceNamePcsPcsServiceNameGlobalUsage(java.lang.String serviceName, java.lang.String pcsServiceName) throws java.io.IOException {
		String __callUrl = "https://api.ovh.com/1.0/cloud/" + serviceName + "/pcs/" + pcsServiceName + "/globalUsage";
		String __data = "?";
		__data += "serviceName=" + serviceName;
		__data += "pcsServiceName=" + pcsServiceName;
		OVHApiMethod __method = OVHApiMethod.GET;
	...
	public net.zyuiop.ovhapi.api.objects.cloud.project.ProjectUsage getProjectServiceNameConsumption(java.util.Date to, java.util.Date from, java.lang.String serviceName) throws java.io.IOException {
		String __callUrl = "https://api.ovh.com/1.0/cloud/project/" + serviceName + "/consumption";
		String __data = "?";
		__data += "to=" + to;
		__data += "from=" + from;
		__data += "serviceName=" + serviceName;
		OVHApiMethod __method = OVHApiMethod.GET;
		URL __url = new URL(__callUrl);
		return new Gson().fromJson(this.client.callRaw(__url, __method, __data, true), net.zyuiop.ovhapi.api.objects.cloud.project.ProjectUsage.class);
	}
