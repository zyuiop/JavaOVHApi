...
public class HadoopImpl implements Hadoop { 
	...
	public net.zyuiop.ovhapi.api.objects.cluster.hadoop.ClusterConsumption getServiceNameConsumptions(java.lang.String serviceName) throws java.io.IOException {
		String __callUrl = "https://api.ovh.com/1.0/cluster/hadoop/" + serviceName + "/consumptions";
		String __data = "?";
		__data += "serviceName=" + serviceName;
		OVHApiMethod __method = OVHApiMethod.GET;
		URL __url = new URL(__callUrl);
		return new Gson().fromJson(this.client.callRaw(__url, __method, __data, true), net.zyuiop.ovhapi.api.objects.cluster.hadoop.ClusterConsumption.class);
	}
	...
	public net.zyuiop.ovhapi.api.objects.cluster.hadoop.NodeBillingProfile[] getServiceNameNodeBillingProfiles(java.lang.String serviceName) throws java.io.IOException {
		String __callUrl = "https://api.ovh.com/1.0/cluster/hadoop/" + serviceName + "/nodeBillingProfiles";
		String __data = "?";
		__data += "serviceName=" + serviceName;
		OVHApiMethod __method = OVHApiMethod.GET;
		URL __url = new URL(__callUrl);
		return new Gson().fromJson(this.client.callRaw(__url, __method, __data, true), net.zyuiop.ovhapi.api.objects.cluster.hadoop.NodeBillingProfile[].class);
	}
	...
	public net.zyuiop.ovhapi.api.objects.cluster.hadoop.NodeBillingProfile[] getOrderableNodeProfiles() throws java.io.IOException {
		String __callUrl = "https://api.ovh.com/1.0/cluster/hadoop/orderableNodeProfiles";
		String __data = "";
		OVHApiMethod __method = OVHApiMethod.GET;
		URL __url = new URL(__callUrl);
		return new Gson().fromJson(this.client.callRaw(__url, __method, __data, true), net.zyuiop.ovhapi.api.objects.cluster.hadoop.NodeBillingProfile[].class);
	...
	public net.zyuiop.ovhapi.api.objects.cluster.hadoop.NodeConsumption[] getServiceNameNodeConsumptions(java.lang.String serviceName) throws java.io.IOException {
		String __callUrl = "https://api.ovh.com/1.0/cluster/hadoop/" + serviceName + "/nodeConsumptions";
		String __data = "?";
		__data += "serviceName=" + serviceName;
		OVHApiMethod __method = OVHApiMethod.GET;
		URL __url = new URL(__callUrl);
		return new Gson().fromJson(this.client.callRaw(__url, __method, __data, true), net.zyuiop.ovhapi.api.objects.cluster.hadoop.NodeConsumption[].class);
	}
