...
public class HpcspotImpl implements Hpcspot { 
	...
	public net.zyuiop.ovhapi.api.objects.hpcspot.Consumption getServiceNameConsumptionId(java.lang.String serviceName, long id) throws java.io.IOException {
		String __callUrl = "https://api.ovh.com/1.0/hpcspot/" + serviceName + "/consumption/" + id + "";
		String __data = "?";
		__data += "serviceName=" + serviceName;
		__data += "id=" + id;
		OVHApiMethod __method = OVHApiMethod.GET;
		URL __url = new URL(__callUrl);
		return new Gson().fromJson(this.client.callRaw(__url, __method, __data, true), net.zyuiop.ovhapi.api.objects.hpcspot.Consumption.class);
	}
