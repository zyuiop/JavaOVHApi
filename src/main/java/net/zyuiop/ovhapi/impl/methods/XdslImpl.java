...
public class XdslImpl implements Xdsl { 
	...
	public net.zyuiop.ovhapi.api.objects.xdsl.orderfollowup.Step[] getServiceNameOrderFollowup(java.lang.String serviceName) throws java.io.IOException {
		String __callUrl = "https://api.ovh.com/1.0/xdsl/" + serviceName + "/orderFollowup";
		String __data = "?";
		__data += "serviceName=" + serviceName;
		OVHApiMethod __method = OVHApiMethod.GET;
		URL __url = new URL(__callUrl);
		return new Gson().fromJson(this.client.callRaw(__url, __method, __data, true), net.zyuiop.ovhapi.api.objects.xdsl.orderfollowup.Step[].class);
	}
	...
	public net.zyuiop.ovhapi.api.objects.xdsl.ExtraIpRangeMove getServiceNameAddressMoveExtraIpRange(java.lang.String serviceName) throws java.io.IOException {
		String __callUrl = "https://api.ovh.com/1.0/xdsl/" + serviceName + "/addressMove/extraIpRange";
		String __data = "?";
		__data += "serviceName=" + serviceName;
		OVHApiMethod __method = OVHApiMethod.GET;
		URL __url = new URL(__callUrl);
		return new Gson().fromJson(this.client.callRaw(__url, __method, __data, true), net.zyuiop.ovhapi.api.objects.xdsl.ExtraIpRangeMove.class);
	}
	...
	public net.zyuiop.ovhapi.api.objects.complextype.UnitAndValues getServiceNameLinesNumberStatistics(java.lang.String period, java.lang.String type, java.lang.String serviceName, java.lang.String number) throws java.io.IOException {
		String __callUrl = "https://api.ovh.com/1.0/xdsl/" + serviceName + "/lines/" + number + "/statistics";
		String __data = "?";
	...
	public net.zyuiop.ovhapi.api.objects.complextype.UnitAndValues getServiceNameStatistics(java.lang.String period, java.lang.String type, java.lang.String serviceName) throws java.io.IOException {
		String __callUrl = "https://api.ovh.com/1.0/xdsl/" + serviceName + "/statistics";
		String __data = "?";
		__data += "period=" + period;
		__data += "type=" + type;
		__data += "serviceName=" + serviceName;
