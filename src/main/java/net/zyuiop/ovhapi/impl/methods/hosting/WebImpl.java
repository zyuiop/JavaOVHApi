...
public class WebImpl implements Web { 
	...
	public net.zyuiop.ovhapi.api.objects.hosting.web.Service getServiceName(java.lang.String serviceName) throws java.io.IOException {
		String __callUrl = "https://api.ovh.com/1.0/hosting/web/" + serviceName + "";
		String __data = "?";
		__data += "serviceName=" + serviceName;
		OVHApiMethod __method = OVHApiMethod.GET;
		URL __url = new URL(__callUrl);
		return new Gson().fromJson(this.client.callRaw(__url, __method, __data, true), net.zyuiop.ovhapi.api.objects.hosting.web.Service.class);
	}
	...
	public net.zyuiop.ovhapi.api.objects.complextype.ChartSerie[] getServiceNameStatistics(java.lang.String period, java.lang.String type, java.lang.String serviceName) throws java.io.IOException {
		String __callUrl = "https://api.ovh.com/1.0/hosting/web/" + serviceName + "/statistics";
		String __data = "?";
		...
		OVHApiMethod __method = OVHApiMethod.GET;
		URL __url = new URL(__callUrl);
		return new Gson().fromJson(this.client.callRaw(__url, __method, __data, true), net.zyuiop.ovhapi.api.objects.complextype.ChartSerie[].class);
	}

	public net.zyuiop.ovhapi.api.objects.hosting.web.Database getServiceNameDatabaseName(java.lang.String serviceName, java.lang.String name) throws java.io.IOException {
		...
		OVHApiMethod __method = OVHApiMethod.GET;
		URL __url = new URL(__callUrl);
		return new Gson().fromJson(this.client.callRaw(__url, __method, __data, true), net.zyuiop.ovhapi.api.objects.hosting.web.Database.class);
	}

	public net.zyuiop.ovhapi.api.objects.hosting.web.ModuleList getModuleListId(long id) throws java.io.IOException {
		String __callUrl = "https://api.ovh.com/1.0/hosting/web/moduleList/" + id + "";
		String __data = "?";
		__data += "id=" + id;
		OVHApiMethod __method = OVHApiMethod.GET;
		URL __url = new URL(__callUrl);
		return new Gson().fromJson(this.client.callRaw(__url, __method, __data, false), net.zyuiop.ovhapi.api.objects.hosting.web.ModuleList.class);
	}
	...
	public net.zyuiop.ovhapi.api.objects.hosting.web.database.CreationDatabaseCapabilities[] getServiceNamePrivateDatabaseCreationCapabilities(java.lang.String serviceName) throws java.io.IOException {
		String __callUrl = "https://api.ovh.com/1.0/hosting/web/" + serviceName + "/privateDatabaseCreationCapabilities";
		String __data = "?";
		__data += "serviceName=" + serviceName;
		OVHApiMethod __method = OVHApiMethod.GET;
		URL __url = new URL(__callUrl);
		return new Gson().fromJson(this.client.callRaw(__url, __method, __data, true), net.zyuiop.ovhapi.api.objects.hosting.web.database.CreationDatabaseCapabilities[].class);
	}
	...
	public net.zyuiop.ovhapi.api.objects.hosting.web.Capabilities getOfferCapabilities(java.lang.String offer) throws java.io.IOException {
		String __callUrl = "https://api.ovh.com/1.0/hosting/web/offerCapabilities";
		String __data = "?";
		__data += "offer=" + offer;
		OVHApiMethod __method = OVHApiMethod.GET;
		URL __url = new URL(__callUrl);
		return new Gson().fromJson(this.client.callRaw(__url, __method, __data, false), net.zyuiop.ovhapi.api.objects.hosting.web.Capabilities.class);
	}
	...
	public net.zyuiop.ovhapi.api.objects.hosting.web.database.CreationDatabaseCapabilities[] getServiceNameDatabaseCreationCapabilities(java.lang.String serviceName) throws java.io.IOException {
		String __callUrl = "https://api.ovh.com/1.0/hosting/web/" + serviceName + "/databaseCreationCapabilities";
		String __data = "?";
		__data += "serviceName=" + serviceName;
		OVHApiMethod __method = OVHApiMethod.GET;
		URL __url = new URL(__callUrl);
	...
	public net.zyuiop.ovhapi.api.objects.complextype.ChartSerie[] getServiceNameDatabaseNameStatistics(java.lang.String period, java.lang.String type, java.lang.String serviceName, java.lang.String name) throws java.io.IOException {
		String __callUrl = "https://api.ovh.com/1.0/hosting/web/" + serviceName + "/database/" + name + "/statistics";
		String __data = "?";
		__data += "period=" + period;
		__data += "type=" + type;
		__data += "serviceName=" + serviceName;
	...
	public void putServiceName(net.zyuiop.ovhapi.api.objects.hosting.web.Service param0, java.lang.String serviceName) throws java.io.IOException {
		String __callUrl = "https://api.ovh.com/1.0/hosting/web/" + serviceName + "";
		String __data = new Gson().toJson(param0);
		OVHApiMethod __method = OVHApiMethod.PUT;
		URL __url = new URL(__callUrl);
