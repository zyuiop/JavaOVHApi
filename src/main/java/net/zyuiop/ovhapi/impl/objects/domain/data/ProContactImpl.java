...
import net.zyuiop.ovhapi.api.objects.domain.data.ProContact;
/**
 * Representation of an .pro Contact Resource
 */

public class ProContactImpl implements ProContact { 
	...
	public ProContactImpl licenseNumber(java.lang.String licenseNumber) { 
		this.licenseNumber = licenseNumber;
		return this;
	} 
	...
	public ProContactImpl jobDescription(java.lang.String jobDescription) { 
		this.jobDescription = jobDescription;
		return this;
	} 
	...
	public ProContactImpl authorityWebsite(java.lang.String authorityWebsite) { 
		this.authorityWebsite = authorityWebsite;
		return this;
	} 
	...
	public ProContactImpl id(long id) { 
		this.id = id;
		return this;
	} 
	...
	public ProContactImpl authority(java.lang.String authority) { 
		this.authority = authority;
		return this;
	} 
