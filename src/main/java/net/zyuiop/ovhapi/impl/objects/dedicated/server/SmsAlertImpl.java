...
import net.zyuiop.ovhapi.api.objects.dedicated.server.SmsAlert;
/**
 * Monitoring SMS alert details, This service is currently not supported for servers at BHS 
 */

public class SmsAlertImpl implements SmsAlert { 
	...
	public SmsAlertImpl phoneNumberTo(java.lang.String phoneNumberTo) { 
		this.phoneNumberTo = phoneNumberTo;
		return this;
	} 
	...
	public SmsAlertImpl smsAccount(java.lang.String smsAccount) { 
		this.smsAccount = smsAccount;
		return this;
	} 
	...
	public SmsAlertImpl language(java.lang.String language) { 
		this.language = language;
		return this;
	} 
	...
	public SmsAlertImpl toHour(long toHour) { 
		this.toHour = toHour;
		return this;
	} 
	...
	public SmsAlertImpl alertId(long alertId) { 
		this.alertId = alertId;
		return this;
	} 
	...
	public SmsAlertImpl fromHour(long fromHour) { 
		this.fromHour = fromHour;
		return this;
	} 
	...
	public SmsAlertImpl enabled(boolean enabled) { 
		this.enabled = enabled;
		return this;
	} 
