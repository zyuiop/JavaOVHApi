...
import net.zyuiop.ovhapi.api.objects.dedicated.server.InstallCustom;
/**
 * A structure describing informations about installation custom
 */

public class InstallCustomImpl implements InstallCustom { 
	...
	public InstallCustomImpl noRaid(boolean noRaid) { 
		this.noRaid = noRaid;
		return this;
	} 
	...
	public InstallCustomImpl sshKeyName(java.lang.String sshKeyName) { 
		this.sshKeyName = sshKeyName;
		return this;
	} 
	...
	public InstallCustomImpl language(java.lang.String language) { 
		this.language = language;
		return this;
	} 
	...
	public InstallCustomImpl useSpla(boolean useSpla) { 
		this.useSpla = useSpla;
		return this;
	} 
	...
	public InstallCustomImpl postInstallationScriptLink(java.lang.String postInstallationScriptLink) { 
		this.postInstallationScriptLink = postInstallationScriptLink;
		return this;
	} 
	...
	public InstallCustomImpl customHostname(java.lang.String customHostname) { 
		this.customHostname = customHostname;
		return this;
	} 
	...
	public InstallCustomImpl installSqlServer(boolean installSqlServer) { 
		this.installSqlServer = installSqlServer;
		return this;
	} 
	...
	public InstallCustomImpl postInstallationScriptReturn(java.lang.String postInstallationScriptReturn) { 
		this.postInstallationScriptReturn = postInstallationScriptReturn;
		return this;
	} 
	...
	public InstallCustomImpl useDistribKernel(boolean useDistribKernel) { 
		this.useDistribKernel = useDistribKernel;
		return this;
	} 
	...
	public InstallCustomImpl softRaidDevices(long softRaidDevices) { 
		this.softRaidDevices = softRaidDevices;
		return this;
	} 
