...
import net.zyuiop.ovhapi.api.objects.email.exchange.SharedAccount;
/**
 * Exchange shared mailbox
 */

public class SharedAccountImpl implements SharedAccount { 
	...
	public SharedAccountImpl quota(long quota) { 
		this.quota = quota;
		return this;
	} 
	...
	public SharedAccountImpl spamTicketNumber(long spamTicketNumber) { 
		this.spamTicketNumber = spamTicketNumber;
		return this;
	} 
	...
	public SharedAccountImpl hiddenFromGAL(boolean hiddenFromGAL) { 
		this.hiddenFromGAL = hiddenFromGAL;
		return this;
	} 
	...
	public SharedAccountImpl state(java.lang.String state) { 
		this.state = state;
		return this;
	} 
	...
	public SharedAccountImpl currentUsage(long currentUsage) { 
		this.currentUsage = currentUsage;
		return this;
	} 
	...
	public SharedAccountImpl lastLogonDate(java.util.Date lastLogonDate) { 
		this.lastLogonDate = lastLogonDate;
		return this;
	} 
	...
	public SharedAccountImpl lastName(java.lang.String lastName) { 
		this.lastName = lastName;
		return this;
	} 
	...
	public SharedAccountImpl id(long id) { 
		this.id = id;
		return this;
	} 
	...
	public SharedAccountImpl sharedEmailAddress(java.lang.String sharedEmailAddress) { 
		this.sharedEmailAddress = sharedEmailAddress;
		return this;
	} 
	...
	public SharedAccountImpl displayName(java.lang.String displayName) { 
		this.displayName = displayName;
		return this;
	} 
	...
	public SharedAccountImpl firstName(java.lang.String firstName) { 
		this.firstName = firstName;
		return this;
	} 
	...
	public SharedAccountImpl initials(java.lang.String initials) { 
		this.initials = initials;
		return this;
	} 
	...
	public SharedAccountImpl spamDetected(boolean spamDetected) { 
		this.spamDetected = spamDetected;
		return this;
	} 
	...
	public SharedAccountImpl lastLogoffDate(java.util.Date lastLogoffDate) { 
		this.lastLogoffDate = lastLogoffDate;
		return this;
	} 
	...
	public SharedAccountImpl creationDate(java.util.Date creationDate) { 
		this.creationDate = creationDate;
		return this;
	} 
	...
	public SharedAccountImpl taskPendingId(long taskPendingId) { 
		this.taskPendingId = taskPendingId;
		return this;
	} 
