...
public class HousingImpl implements Housing { 
	...
	public HousingImpl network(net.zyuiop.ovhapi.api.objects.dedicated.housing.NetworkInfo network) { 
		this.network = network;
		return this;
	} 
	...
	public HousingImpl options(net.zyuiop.ovhapi.api.objects.dedicated.housing.Options options) { 
		this.options = options;
		return this;
	} 
