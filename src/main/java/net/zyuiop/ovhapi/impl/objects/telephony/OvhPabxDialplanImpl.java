...
import net.zyuiop.ovhapi.api.objects.telephony.OvhPabxDialplan;
/**
 * Dialplan
 */

public class OvhPabxDialplanImpl implements OvhPabxDialplan { 
	...
	public OvhPabxDialplanImpl lastUpdate(java.util.Date lastUpdate) { 
		this.lastUpdate = lastUpdate;
		return this;
	} 
	...
	public OvhPabxDialplanImpl name(java.lang.String name) { 
		this.name = name;
		return this;
	} 
	...
	public OvhPabxDialplanImpl showCallerNumber(java.lang.String showCallerNumber) { 
		this.showCallerNumber = showCallerNumber;
		return this;
	} 
	...
	public OvhPabxDialplanImpl transferTimeout(long transferTimeout) { 
		this.transferTimeout = transferTimeout;
		return this;
	} 
	...
	public OvhPabxDialplanImpl dialplanId(long dialplanId) { 
		this.dialplanId = dialplanId;
		return this;
	} 
	...
	public OvhPabxDialplanImpl anonymousRejection(boolean anonymousRejection) { 
		this.anonymousRejection = anonymousRejection;
		return this;
	} 
