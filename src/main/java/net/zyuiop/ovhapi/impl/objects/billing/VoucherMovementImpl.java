...
public class VoucherMovementImpl implements VoucherMovement { 
	...
	public VoucherMovementImpl amount(net.zyuiop.ovhapi.api.objects.order.Price amount) { 
		this.amount = amount;
		return this;
	} 
	...
	public VoucherMovementImpl balance(net.zyuiop.ovhapi.api.objects.order.Price balance) { 
		this.balance = balance;
		return this;
	} 
	...
	public VoucherMovementImpl previousBalance(net.zyuiop.ovhapi.api.objects.order.Price previousBalance) { 
		this.previousBalance = previousBalance;
		return this;
	} 
