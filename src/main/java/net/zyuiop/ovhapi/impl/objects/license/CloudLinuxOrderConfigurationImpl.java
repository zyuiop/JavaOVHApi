...
public class CloudLinuxOrderConfigurationImpl implements CloudLinuxOrderConfiguration { 
	...
	public CloudLinuxOrderConfigurationImpl orderableVersions(net.zyuiop.ovhapi.api.objects.license.OrderableCloudLinuxCompatibilityInfos orderableVersions) { 
		this.orderableVersions = orderableVersions;
		return this;
	} 
